...
import { ChipBaseExtendPropey } from './ChipBaseExtendPropey';
 // import
export const ChipICND2150SExtendPropertyBase = t.intersection(
  [
  ...
  'ChipICND2150SExtendPropertyBase'
);
/**
 * Codec for {@link ChipICND2150SExtendProperty}
 * @category Codecs
 * @see Automatically generated from ../decompiled/Nova.LCT.GigabitSystem.ChipICND2150S.decompiled.cs:2360
 */
export const ChipICND2150SExtendProperty = t.intersection(
  [
    ChipICND2150SExtendPropertyBase,
    t.partial({ '@_xsi:type': t.literal('ChipICND2150SExtendProperty') }),
  ],
  'ChipICND2150SExtendProperty'
);
export interface ChipICND2150SExtendProperty extends t.TypeOf<typeof ChipICND2150SExtendProperty> {}
